...
| MAN-013 | TC-MSG-03 | Kevin + Codex | Simultaneous authenticated administrator in Chrome and contributor in Edge | Messages and categorized notifications arrive without reload in both directions | Admin-to-contributor and contributor-to-admin messages appeared live; unread badges and Messages notification links updated correctly | `Docs/EXTERNAL_STAGING_SMOKE_TEST_2026-09-21.md` |  | Pass | 2026-09-21 |
| MAN-014 | Community real-time reply | Kevin + Codex | Simultaneous authenticated administrator in Chrome and contributor in Edge | A new comment appears live and creates a categorized deep-linked notification | Comment and reply count appeared without reload; Community notification linked to `/community/14#comment-17` | `Docs/EXTERNAL_STAGING_SMOKE_TEST_2026-09-21.md` |  | Pass | 2026-09-21 |
| MAN-015 | Administrator staging smoke | Kevin + Codex | Existing administrator session on Railway/Vercel staging | Admin sections load and contributor remains denied | Dashboard, health, suggestions, 37 herbs, 7 users, 33 KB facts and audit entries loaded; contributor `/admin` denial passed | `Docs/EXTERNAL_STAGING_SMOKE_TEST_2026-09-21.md` |  | Pass | 2026-09-21 |
...
| DEF-AI-02 | Moderate | Dr. AI unknown-source boundary | Unknown `moonflower xyz` correctly refused dosage but previously displayed unrelated FAQ citations for commercial remedies and Niyog-niyogan | Backend/AI | **Closed — Live Retest Passed 2026-09-21** | Plant-specific lexical filtering plus vector distance; two regressions; 175/175 tests; Railway commit `1500240`; live response contained no source cards or unrelated citations |
